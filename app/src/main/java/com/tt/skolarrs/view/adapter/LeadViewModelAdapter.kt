...
class LeadViewModelAdapter(
    var context: Context, var listType: String,
    var list: ArrayList<UpdatedList>,
    var listener: Listener,
) : RecyclerView.Adapter<LeadViewModelAdapter.ViewHolder>() {
    ...
    fun filterList(filterlist: ArrayList<UpdatedList>) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        /* holder.binding.container.setOnClickListener(object : DoubleClickListener() {
             override fun onDoubleClick(v: View?) {
                 listener.openDialogBox(
                     list.modifiedList._id,
                     MyFunctions.dateFormat(list.modifiedList.date)!!
                 )
             }
         })*/
